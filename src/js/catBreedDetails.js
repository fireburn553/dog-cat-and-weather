...
async function catDetails(id) {
    ...
    const ImgContainer = createElement('div', {className: 'img-container'}, [breedImage])
    ...
    const detailsDiv = createElement('div', {className: "details-container"}, [breedName, descriptionParagraph, likeButton])

    return createElement('div', {className: 'breed-details'}, [ImgContainer, detailsDiv]  );
    }catch (error){
