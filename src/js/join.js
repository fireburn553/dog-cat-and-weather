...
async function join() {
    ...
    const joinForm = createElement('form', { id: 'join-form' }, [
        ...
        createElement('label', { for: 'petType', textContent: 'Select your pet type: ' }), // Add a space after the colon
        ...
        createElement('label', { for: 'petBreed', textContent: 'Enter your pet breed: ' }), // Add a space after the colon
    ...
    joinForm.addEventListener('submit', async function (event) {
        ...
        alert('Join successful!'); // Replace this with your actual submission logic
    ...
    return createElement('div', { className: 'join-section' }, [joinTitle, joinContainer]);
}
