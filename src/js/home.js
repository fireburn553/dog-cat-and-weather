import { createElement, fetchData, getLocation, formatTime, capitalize } from './utils';
...
async function home() {
    try {
        ...
        const catElement = imageDiv('Cat', catData, 'cat-random-image', 'Random Cat Image Today! Enjoy');
        const dogElement = imageDiv('Dog', dogData, 'dog-random-image', 'Random Dog Image Today! Enjoy');
...
export function imageDiv(category, data, className, text) {
    ...
    return createElement('div', { className: 'element-container' }, [cardTitle, picture, label]);
}
...
function displayWeatherInfo(weatherData) {
    ...
    return createElement('div', {className: 'element-container'}, [cardTitle, place, iconWeather,weatherDesc, weatherInfoElement, sunRiseSet]);
}
